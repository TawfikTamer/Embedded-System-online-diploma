...
#define lcd_SecLine                   0xc0          // put cursor on the 2nd line
#define lcd_CursorLeft                0x10          // shift cursor position to left
#define lcd_CursorRight               0x14          // shift cursor position to right
